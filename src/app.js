...
(function () {
  ...
  const bindScrollProxy = () => {
    ...
    // На мобильных touch-scroll внутри iframe вызывает рывки родительской страницы.
    // Поэтому жесты по Башне не прокидываем наверх: родитель можно скроллить вне iframe.
